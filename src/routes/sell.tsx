...
export const Route = createFileRoute("/sell")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "List your used university textbook for sale or swap in a few seconds." },
      { property: "og:title", content: "Sell a textbook — SecondHand Textbook Swap" },
      { property: "og:description", content: "Publish your used textbook to students on your campus." },
    ],
  }),
  component: () => (
    <AppShell>
